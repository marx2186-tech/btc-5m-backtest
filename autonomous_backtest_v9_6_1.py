...
RESULTS = ROOT / "results_v9_6_1"
RESULTS.mkdir(exist_ok=True)
ENGINE_VERSION = "V9.6.1"
ENGINE_NAME = "BTC 5m sparse expert discovery and soft-meta pool V9.6.1"
OOS_MONTH = "2026-06"

REQUEST_PATH = Path(os.environ.get("BACKTEST_REQUEST_FILE", str(ROOT / "request.v9_6_1.json")))
...
compat = ROOT / ".v961_base_request.json"
...
spec = importlib.util.spec_from_file_location("v961_base_engine", ROOT / "_v961_base_engine.py")
